...
router.get("/categories", validateAutMiddleware(["configurator", "admin"]), async (req, res, next) => {
    try {
...
router.post("/expenses", validateAutMiddleware(["admin", "configurator", "owner"]), async (req, res, next) => {
